...
[Movie, Colormap] = eegmovie_parallel_dual_optimized(difference_voltage, actual_srate, LIMO.data.chanlocs, ...
    'title', sprintf('Retrieval Success Effect Topoplot (%.1fx speed, %d fps)', time_multiplier, target_frame_rate), ...
    'data2', plot_data, ...
    'mode', '2D', ...
    'layout', 'dual', ...
    'title', 'Retrieval Success Effect Topoplot', ...
    'subtitle1', 'Voltage Difference (μV)', ...
    'subtitle2', 'Paired T-test T-values', ...
