...
[Movie, Colormap] = eegmovie_parallel_dual(plot_data, actual_srate, LIMO.data.chanlocs, ...
    'title', sprintf('Paired T-test Animation (%.1fx speed, %d fps)', time_multiplier, target_frame_rate), ...
    'data2', plot_data, ...
    'mode', '2D', ...
    'layout', 'dual', ...
    'title', 'ERP vs Statistics Comparison', ...
    'subtitle1', 'Voltage (μV)', ...
    'subtitle2', 't-value', ...
    'colormap2', colormap2, ...
    'minmax', colorbar_limits, ...
